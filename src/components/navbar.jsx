...
//   return (
//     <nav className="fixed top-0 w-full z-50 bg-black/40 backdrop-blur-lg shadow-lg transition-all">
...
//                 key={label}
//                 onClick={() => goToStep(stepNum)}
//                 className={`nav-btn ${step === stepNum ? "active" : ""}`}
//               >
//                 {label}
//               </button>
//             );
...
//           <button
//             onClick={toggleDark}
//             className="px-3 py-1 rounded font-semibold bg-white text-black"
//           >
//             {darkMode ? "Light" : "Dark"}
//           </button>
//         </div>
...
//       {/* Mobile Menu */}
//       {open && (
//         <div className="md:hidden mt-4 flex flex-col gap-3 px-6 pb-4">
//           {["Form", "Details", "Review"].map((label, index) => {
//             const stepNum = index + 1;
//             return (
//               <button
...
//           <button
//             onClick={toggleDark}
//             className="px-3 py-2 rounded font-semibold bg-white text-black"
//           >
//             {darkMode ? "Light" : "Dark"}
//           </button>
//         </div>
